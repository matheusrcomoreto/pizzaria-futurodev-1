...
public class PedidoController {
    ...
    public ResponseEntity<Pedido> fecharConta(@PathVariable Long idPedido, @PathParam("numeroCartao") String numeroCartao) {
       return ResponseEntity.ok(this.pedidoService.fecharConta(idPedido, numeroCartao));
    }
